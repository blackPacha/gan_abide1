...
if __name__ == '__main__':
    list_of_imgs_files = list(map(lambda x: "/anatpreproc/ABIDE_1/cpac_registered/" + x, os.listdir("/anatpreproc/ABIDE_1/cpac_registered")))
    outdir = '/anatpreproc/ABIDE_1/cpac_sample_16'
    x_size_of_filter = 16
    y_size_of_filter = 16
    z_size_of_filter = 16
